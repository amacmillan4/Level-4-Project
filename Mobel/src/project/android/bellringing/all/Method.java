...
public class Method{
	...
	//Special Cases
	private void checkSpecialCasesBob(){
		if (methodName.equals("Grandsire")){
			methodBob.set(methodBob.size()-1, "3");
		}
	}

	private void checkSpecialCasesSingle(){
		if (methodName.equals("Grandsire")){
			methodSingle.set(methodSingle.size()-1, "3");
		}
	}

	//Displays when bob or single is coming up
	...
	//Plays through the method and returns the text specific to a Bob
	...
	//Logic to select bob and single changes
	...
	//Calculates wether the next method will be a bob or single
